...
var matchmaking_service_1 = require("./matchmaking.service");
var passport_1 = require("@nestjs/passport");
var MatchmakingController = /** @class */ (function () {
    function MatchmakingController(matchmakingService) {
        this.matchmakingService = matchmakingService;
    }
    MatchmakingController.prototype.findMatches = function (response, req) {
        return __awaiter(this, void 0, void 0, function () {
            var userId, matchesWithNames, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.matchmakingService.findMatches(userId)];
                    case 2:
                    ...
                    case 3:
                        error_1 = _a.sent();
                        response.status(500).json({ message: 'Une erreur est survenue lors de la recherche des correspondances.', error: error_1.toString() });
                        return [3 /*break*/, 4];

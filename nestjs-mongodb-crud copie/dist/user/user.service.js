...
let UserService = class UserService {
    ...
    async createUser(createUserDto) {
        try {
            ...
            const userToSave = Object.assign(Object.assign({}, createUserDto), { password: hashedPassword });
    ...
    async getUserTypeById(userId) {
        var _a;
        const user = await this.userModel.findById(userId).select('typeUser').exec();
        return (_a = user === null || user === void 0 ? void 0 : user.typeUser) === null || _a === void 0 ? void 0 : _a.role;
    }
};
